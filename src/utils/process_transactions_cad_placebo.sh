...
transaction_base="data/processed/CAD/placebo"
yield_curve_base="data/raw/curves/CAD"
output_base="data/results/CAD/placebo"
...
for transaction_file in "$transaction_base"/*_output.xlsx; do
    ...
    yield_curve_file="$yield_curve_base/cad_${curve_date_str}.xlsx"

    # Set the output file path
    output_file="$output_base/CAD_${date_str}_priced.xlsx"

...
transaction_base="data/processed/EUR"
yield_curve_base="data/raw/curves/EUR"
output_base="data/results/EUR"
...
for transaction_file in "$transaction_base"/*_output.xlsx; do
    ...
    yield_curve_file="$yield_curve_base/EUR_Curve_${curve_date_str}.xlsx"

    # Set the output file path
    output_file="$output_base/EUR_${date_str}_priced.xlsx"

set seed 12345
capture program drop baseline_case_h
program define baseline_case_h, rclass
    version 17.0
	...
	* GME projection
	...
	matrix support = (-5, 0, 5 \ -5, 0, 5 \ -5,  0, 5)
	
	// Run GME linear regression
	gmentropylinear y_tilde_star X1_star X2_star c_star, ///
		nocons support(support)
	
	// Predict and compute ATT
	predict ghat_gme_, xb
	return scalar coef_X1_gme = e(b)["y1", "X1_star"]
	return scalar coef_X2_gme = e(b)["y1", "X2_star"]
	return scalar intercept_gme = e(b)["y1", "c_star"]
